...
import ru.mirza.dop.KawaiiHashSet;
...
class StackM {
    ...
    private HashMap<String, KawaiiHashSet> hashMap = new HashMap<>();
    ...
    void calculate(List<Token> tokens) {
        ...
        for (int i = 0; i < tokens.size(); i++) {
            switch (tokens.get(i).getType()) {
                ...
                case "TYPE":
                    ...
                    stack.pop();
                    hashMap.put(hashSetNewKey, new KawaiiHashSet());
                ...
                case "CONTAINS":
                    ...
                    KawaiiHashSet hashSet = hashMap.get(hashSetKey);
    ...
    private void set_rpn(String b, String a, String value, KawaiiHashSet hashSet) {
        switch (value) {
            case "add":
                hashSet.add(b);
